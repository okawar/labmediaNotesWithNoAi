    ...
    <div class="modal-backdrop" v-show="modalAddVisible">
        <div class="modal">
            ...
            <form action="" class="modal-form">
                ...
                <button type="button" class="modal-btn-add-image">
                ...
                <div class="button-group">
                    <button type="button" class="modal-btn-cancel" @click="emit('closeAddModal'); clearForm()">Отменить</button>
                    <button type="submit" class="modal-btn-add" @click.prevent="emit('addNote', { title: title, content: content }); clearForm();">Сохранить</button>
                </div>
            </form>
        </div>
    </div>
